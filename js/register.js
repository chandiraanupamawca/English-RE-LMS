      ...
      if ($$("gen").value == "") {
        ...
        if ($$("birthday").value == "") {
          ...
          if (validateEmail(em) == false) {
            ...
            if (
              $$("phoneNumber").value == "" ||
              String(pn).slice(0, 2) != "07" ||
              pn.toString().length != 10
            ) {
              Swal.fire(
              ...
              if ($$("address").value == "") {
                ...
                if (
                  ...
                  String($$("whatsappNumber").value).slice(0, 2) != "07" ||
                  $$("whatsappNumber").value.toString().length != 10
                ) {
                  Swal.fire(
    ...
    if (res == null) {
      ...
      firebase
        ...
        .then((confirmationResult) => {
          ...
          $$("verifyt").innerText =
            "Enter the code sent to your mobile number. It may take upto 2 minutes to receive an OTP.";
    ...
    confirmationResult
      ...
      .then((result) => {
        ...
        if (result.additionalUserInfo.isNewUser) {
          ...
          $$("popp").innerHTML =
            "<div id='dan' class='animated fadeIn'> <div id='upper-sided'><h3 id='status'> Error </h3> </div> <div id='lower-side'> <p id='message'> The Phone number already exists. Sorry try siginig using another number. </p> <a onclick='location.reload()' id='contBtnd'>Reload</a> </div> </div>";
        }
        // ...
      })
      .catch((error) => {
